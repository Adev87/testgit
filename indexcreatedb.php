$servername = "localhost";
     ...
     $sql = "CREATE DATABASE `Electrical_IoT`CHARACTER SET utf8 COLLATE utf8_bin; ";
      ...
      run_query($mysqli,$sql);
      $sql = "USE Electrical_IoT;
      CREATE TABLE `Electrical_IoT`.`Device` ( `id` INT NOT NULL AUTO_INCREMENT, 
      `mac` VARCHAR(20), `devicename` VARCHAR(50), `devicenickname` VARCHAR(50)
      , PRIMARY KEY (`id`)     
      )
  ...
  function insert_after_check_mac_last_update($conn,$dv)
  {
    ...
    $sql = "INSERT INTO Device_Data (device_id, current, watts,temperature,time)
    VALUES ('".$dv->device_id."', '"
    .$dv->current."', '"
    .$dv->watts."', '"
    .$dv->temperature."', '"
